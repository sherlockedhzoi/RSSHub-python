...
def parse(post):
    return {
        'title': post.find('span', id='ReportIDname').a.text.encode('latin1').decode('utf-8'),
        'description': (post.find('span', id='ReportIDname').a.text + post.find('span', id='ReportIDIssueTime').text).encode('latin1').decode('utf-8'),
